      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-12 py-16 max-w-7xl mx-auto">
        <div className="col-span-1 md:col-span-1">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-blue-700 shadow-sm hover:translate-y-[-2px] transition-transform">
            ...
            <a href="https://facebook.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-blue-700 shadow-sm hover:translate-y-[-2px] transition-transform">
            ...
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-blue-700 shadow-sm hover:translate-y-[-2px] transition-transform">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm mb-4 flex gap-2"><span className="material-symbols-outlined text-sm">location_on</span> Himayatnagar, Hyderabad, Telangana</p>
          <div className="text-slate-500 text-sm mb-4 flex gap-2">
            ...
            <div className="flex flex-col gap-1">
              <a href="tel:+918143143145" className="hover:text-blue-600 transition-colors">+91 81431 43145</a>
              <a href="tel:+919885010913" className="hover:text-blue-600 transition-colors">+91 98850 10913</a>
            </div>
          </div>
          <p className="text-slate-500 text-sm mb-6 flex gap-2"><span className="material-symbols-outlined text-sm">mail</span> admissions@svprofessionals.com</p>
        </div>
      </div>
