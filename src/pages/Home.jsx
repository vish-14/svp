...
const Home = () => {
  ...
  const testimonialVideos = [
    {
      id: 1,
      driveId: "1BszVnnNWymoWCyeXC2MkhImIVlgjsJWB",
      src: "/videos/video1.mp4",
    },
    {
      id: 2,
      driveId: "1TPmCYU8mWtpHCj61sI-m4RDBTADAOtbO",
      src: "/videos/video2.mp4",
    },
    {
      id: 3,
      driveId: "1qm9FXmJ0elQYuvmhHTSPOft1EJtei9_V",
      src: "/videos/video3.mp4",
    },
    {
      id: 4,
      driveId: "1G4tmf-MU-k0jUZElo3LC0QNl3Q0B_TDG",
      src: "/videos/reality_after_graduation.mp4",
    },
    {
      id: 5,
      driveId: "1PR1SAKh8j3NnyeNsZN6XpICTc9ZtcnP8",
      src: "/videos/video1.mp4",
    },
    {
      id: 6,
      driveId: "1i-T2g2nSzTfnM9ChtzQIRd69JY9PvJW6",
      src: "/videos/video2.mp4",
    },
    {
      id: 7,
      driveId: "1xMjkE3hKnpOyh19WaGjAwpIP65rYVp_x",
      src: "/videos/video3.mp4",
    },
  ];
  ...
  return (
    <>
      ...
      <motion.section
        ...
        className="bg-[#F8FAFC] pt-12 md:pt-20 pb-16 md:pb-24 overflow-hidden border-b border-slate-200"
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.6fr,1.4fr] gap-10 lg:gap-16 items-start">
            ...
            <div className="flex flex-col items-start pt-4">
              <h1 className="text-3xl md:text-4xl lg:text-[42px] font-black text-[#0F172A] leading-[1.2] mb-3 tracking-tight">
                {homeData.heroTitlePrefix}
                <span className="text-[#2563eb]">
                  {homeData.heroTitleHighlight}
                </span>
              </h1>
                ...
                {homeData.stats.map((stat, index) => (
                  <React.Fragment key={index}>
                    <div className="flex flex-col">
                      <span className="text-2xl sm:text-xl font-black text-[#0F172A] leading-none">
                        {stat.value}
                      </span>
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center w-full sm:w-auto mt-2">
                ...
                >
                  Talk to Counsellor{" "}
                  <span className="material-symbols-outlined text-[20px] text-slate-400 group-hover:text-[#1E40AF]">
                    call
                  </span>
                </Link>
              </div>
            ...
            <div className="w-full mt-6 lg:mt-0">
              <div className="bg-white p-7 md:p-8 rounded-2xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-slate-100 max-w-[420px] mx-auto lg:ml-auto lg:mr-0 relative">
                ...
                <div className="mb-6">
                  <h3 className="text-2xl font-black text-[#0F172A] mb-1.5 tracking-tight">
                    Book Free Counselling
                  </h3>
                  <p className="text-slate-500 text-sm font-medium">
                    Get a call from our expert mentors.
                  </p>
                </div>
            ...
            <div className="flex flex-row flex-wrap items-center justify-center gap-x-12 gap-y-6 md:gap-16">
              <div className="flex items-center gap-3.5">
                <img
                  ...
                  alt="Google"
                />
                <span className="text-[15px] font-extrabold text-[#0F172A] font-inter">
                  Google
                </span>
                ...
                <span className="text-[14px] font-bold text-slate-600 font-inter">
                  4.9/5
                </span>
              </div>
              ...
              <div className="flex items-center gap-3.5">
                <img
                  className="h-5 w-5 object-contain"
                  src="https://www.justdial.com/favicon.ico"
                  alt="JustDial"
                />
                <span className="text-[15px] font-extrabold text-[#0F172A] font-inter">
                  JustDial
                ...
                <span className="text-[14px] font-bold text-slate-600 font-inter whitespace-nowrap">
                  4.9/5
                </span>
              </div>
            </div>
      ...
      >
        <div className="max-w-[1240px] mx-auto px-6">
          <div className="mb-14 text-center lg:text-left">
            <h2 className="text-[36px] md:text-[44px] font-black text-[#0F172A] leading-tight mb-4 tracking-tighter">
              Master In-Demand Programs
            </h2>
            <p className="text-slate-500 max-w-2xl text-lg font-medium leading-relaxed">
              Fast-track your career with practical training designed by
              industry pioneers.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {homeData.programsData && homeData.programsData.map((prog, idx) => (
            <div key={idx} className="sticky top-24 md:static z-10 group bg-white border border-slate-100 rounded-lg shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)] transition-all duration-500 flex flex-col relative mt-12 md:mt-0">
              <div className="p-6 pb-0 flex justify-between items-start min-h-[140px] relative">
                <div className="mt-2">
                  <div className="text-[#2563EB] font-black text-xs uppercase tracking-widest mb-1">
                    {prog.category}
                  </div>
                  <div className="text-[#1E40AF] font-black text-lg tracking-tight leading-tight max-w-[150px]">
                    {prog.title}
                  </div>
                </div>
                <motion.div
                  style={{ y: idx === 0 ? y1 : idx === 1 ? y2 : y3 }}
              ...
              <div className="px-6 py-4 flex flex-wrap gap-2">
                {prog.badges && prog.badges.map((badge, bIdx) => (
                  <span key={bIdx} className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider ${
                    badge.color === 'indigo' ? 'bg-indigo-50 text-indigo-600' :
                    badge.color === 'emerald' ? 'bg-emerald-50 text-emerald-600' :
                    badge.color === 'fuchsia' ? 'bg-fuchsia-50 text-fuchsia-600' :
              ...
              <div className="px-6 pb-6 flex-1 flex flex-col">
                <div className="space-y-3.5 mb-6 mt-2">
                  {prog.highlights && prog.highlights.map((hl, hlIdx) => (
                    <div key={hlIdx} className={`flex ${hl.subtitle ? 'items-start' : 'items-center'} gap-3`}>
                      <span className="material-symbols-outlined text-blue-600 text-[18px] bg-blue-50 p-1.5 rounded-lg shrink-0">
                        {hl.icon}
                      </span>
                      {hl.subtitle ? (
                        <div className="flex flex-col">
                ...
                <div className="mt-auto space-y-4">
                  <div className="flex items-center justify-between text-xs py-3 border-t border-slate-50">
                    ...
                    <div className="flex items-center gap-1.5 text-orange-500 font-black italic">
                      <span className="material-symbols-outlined text-[16px]">
                        {prog.alertIcon || 'local_fire_department'}
                      </span>
                      {prog.alertText}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    <button
                      onClick={() => setIsModalOpen(true)}
                      className="w-full bg-[#2563EB] text-white font-black py-4 rounded-lg text-sm transition-all hover:bg-blue-700 active:scale-95 shadow-lg shadow-blue-500/10"
                    >
                      Request Callback
                    </button>
                    <Link
                      to={prog.link}
                      className="w-full border border-blue-100 text-[#2563EB] font-black py-3 rounded-lg text-sm text-center hover:bg-blue-50 transition-all"
                    >
                      Know More
                    </Link>
                  </div>
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-8 md:flex md:flex-row items-stretch justify-items-center justify-between md:gap-0">
            ...
            <div className="flex flex-col items-center justify-center flex-1 group">
              <div className="h-14 flex items-center justify-center mb-3">
                <img
                  className="h-11 w-auto object-contain md:grayscale md:opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-300"
                  src="https://syprosmartautomation.com/logos/msme-logo.png"
                  alt="MSME"
                />
              </div>
              <span className="text-[9px] font-black uppercase tracking-[0.15em] text-[#64748B]">
                MSME Certified
              </span>
            </div>
            ...
            <div className="flex flex-col items-center justify-center flex-1 group">
              <div className="h-14 flex items-center justify-center mb-3">
                <img
                  className="h-12 w-auto object-contain md:grayscale md:opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-300"
                  src="https://isofocus.co.id/wp-content/uploads/2024/03/iso-9001-2015-qms-removebg-preview.png"
                  alt="ISO"
                />
              </div>
              <span className="text-[9px] font-black uppercase tracking-[0.15em] text-[#64748B]">
            ...
            <div className="flex flex-col items-center justify-center flex-1 group">
              <div className="h-14 flex items-center justify-center mb-3">
                <img
                  className="h-8 w-auto object-contain md:grayscale md:opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-300"
                  src="https://companieslogo.com/img/orig/SAP_BIG-323a7da5.png?t=1633439411"
                  alt="SAP"
                />
              </div>
              <span className="text-[9px] font-black uppercase tracking-[0.15em] text-[#64748B]">
            ...
            <div className="flex flex-col items-center justify-center flex-1 group">
              <div className="h-14 flex items-center justify-center mb-3">
                <img
                  className="h-10 w-auto object-contain md:grayscale md:opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-300"
                  src="https://www.image2url.com/r2/default/images/1779270684366-17fcdd8f-85ec-4cea-ba9e-8a7bdcf4ec96.png"
                  alt="Microsoft Excel"
                />
              </div>
              <span className="text-[9px] font-black uppercase tracking-[0.15em] text-[#64748B]">
                ADV Excel Certified Trainers
              </span>
            </div>
            ...
            <div className="flex flex-col items-center justify-center flex-1 group">
              <div className="h-14 flex items-center justify-center mb-3">
                <img
                  className="h-10 w-auto object-contain md:grayscale md:opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-300"
                  src="https://www.image2url.com/r2/default/images/1779270916595-dc3c8448-6c68-4988-ba16-58d24c4163b5.png"
                  alt="IAF"
                />
              </div>
              <span className="text-[9px] font-black uppercase tracking-[0.15em] text-[#64748B]">
            ...
            <div className="flex flex-col items-center justify-center flex-1 group">
              <div className="h-14 flex items-center justify-center mb-3">
                <img
                  className="h-12 w-auto object-contain md:grayscale md:opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-300"
                  src="https://www.image2url.com/r2/default/images/1783597984794-9a62736e-df3c-42e3-bb53-9a46914971a0.jpg"
                  alt="SV Professionals"
                />
              </div>
              <span className="text-[9px] font-black uppercase tracking-[0.15em] text-[#64748B]">
                SV Professionals
      ...
      >
        <div className="max-w-[1140px] mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-[32px] md:text-[36px] font-black text-[#0F172A] leading-tight mb-8 tracking-tight">
                Four Steps to Your{" "}
                <span className="text-[#2563EB]">Dream Career</span>
              </h2>
              ...
              <div className="relative space-y-6">
                ...
                <div className="flex gap-5 items-start relative">
                  <div className="w-8 h-8 shrink-0 rounded-[4px] bg-[#2563EB] text-white flex items-center justify-center font-black text-[12px] z-10">
                    01
                  </div>
                  <div>
                    <h4 className="text-[17px] font-black text-[#0F172A] mb-0.5 leading-tight tracking-tight">
                      Enrollment & Assessment
                    </h4>
                    <p className="text-[#64748B] text-[13.5px] leading-[1.5] max-w-sm line-clamp-2">
                      We evaluate your goals and align you with the right
                ...
                <div className="flex gap-5 items-start relative">
                  ...
                  <div>
                    ...
                    <p className="text-[#64748B] text-[13.5px] leading-[1.5] max-w-sm line-clamp-2">
                      Intensive skill-building through industry software and
                      expert-led modules.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-5 items-start relative">
                  ...
                  <div>
                    ...
                    <p className="text-[#64748B] text-[13.5px] leading-[1.5] max-w-sm line-clamp-2">
                      Apply your learning to real-world business scenarios to
                ...
                <div className="flex gap-5 items-start relative">
                  ...
                  <div>
                    ...
                    <p className="text-[#64748B] text-[13.5px] leading-[1.5] max-w-sm line-clamp-2">
                      Direct interview opportunities with our hiring network and
                      success workshops.
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-on-surface-variant">
              Our mentors are industry leaders with decades of combined
              experience.
            </p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-x-4 gap-y-12 sm:gap-8 lg:gap-y-16 mt-8">
            <div className="text-center group">
              ...
              <div className="text-[12px] md:text-[13px] font-bold text-on-surface leading-tight px-1">
                POCHAMPALLY SUDHEER REDDY
              </div>
              <div className="text-[10px] md:text-[11px] text-primary font-bold uppercase tracking-wider mt-1 leading-tight">
                FOUNDER & CHAIRMAN
              </div>
            </div>
            <div className="text-center group">
              ...
              <div className="text-[10px] md:text-[11px] text-slate-500 font-bold uppercase tracking-wider mt-1 leading-tight">
            ...
            <div className="text-center group">
              <div className="w-32 h-32 mx-auto rounded-2xl overflow-hidden mb-4 p-1 bg-white shadow-xl ring-2 ring-outline-variant group-hover:ring-primary transition-all duration-500 group-hover:-translate-y-4 group-hover:shadow-[0_20px_40px_-5px_rgba(37,99,235,0.4)]">
                <motion.img
                  className="w-full h-full object-cover object-top rounded-2xl transition-all duration-500"
                  alt="Ravi Varun Reddy"
                  src="/images/ravi_varun_reddy.png"
                  initial={{ scale: 1.1, opacity: 0 }}
                  whileInView={{ scale: 1, opacity: 1 }}
                  transition={{ duration: 0.8 }}
                  viewport={{ once: true }}
            ...
            <div className="text-center group">
              <div className="w-32 h-32 mx-auto rounded-2xl overflow-hidden mb-4 p-1 bg-white shadow-xl ring-2 ring-outline-variant group-hover:ring-primary transition-all duration-500 group-hover:-translate-y-4 group-hover:shadow-[0_20px_40px_-5px_rgba(37,99,235,0.4)]">
                <motion.img
                  className="w-full h-full object-cover object-top rounded-2xl transition-all duration-500 grayscale opacity-80"
                  alt="VIRAJA"
              ...
              <div className="text-[10px] sm:text-[11px] text-slate-500 font-semibold mt-1 uppercase tracking-wider leading-tight">
                FINANCE EXPERT
              </div>
              <div className="text-[9px] sm:text-[10px] text-slate-400 font-medium mt-0.5">
                (ACCA CERTIFIED)
      ...
      <motion.section
        ...
        viewport={{ once: true, amount: 0.1 }}
        transition={{ duration: 0.7, ease: "easeOut" }}
        className="py-20 bg-slate-50 overflow-hidden border-y border-slate-100"
      >
        <div className="w-full text-center">
          ...
          <p className="text-sm text-slate-500 font-medium mb-8">
            50+ companies actively hiring our certified HR professionals
          </p>
              ...
              {[1, 2].map((i) => (
                <div key={i} className="flex items-center gap-24 pr-24">
                  <img
                    ...
                    src="https://tse1.mm.bing.net/th/id/OIP.x8Ug5pA6_Z5YnY18cn9mXwHaBn?rs=1&pid=ImgDetMain&o=7&rm=3"
                    alt="Deloitte"
                  />
                  <img
                  ...
                  <img
                    ...
                    src="https://latestlogo.com/wp-content/uploads/2024/01/tata-consultancy-services-logo.png"
                    alt="TCS"
                  />
                  <img
                  ...
                  <img
                    className="h-6 md:h-8 w-auto object-contain"
                    src="https://alexahire.in/wp-content/uploads/2024/05/genpact-logo.jpg"
                    alt="Genpact"
                  />
                  <img
                    className="h-8 md:h-10 w-auto object-contain"
        ...
        <div className="max-w-[1140px] mx-auto px-6">
          ...
          <div className="flex justify-between items-center mb-4 px-1">
            ...
            <button
              onClick={() =>
                setActiveVideoIdx((prev) =>
                  prev === null ? 0 : (prev + 1) % testimonialVideos.length,
                )
              }
          ...
          >
            {testimonialVideos.map((vid, idx) => {
              ...
              const progress = isActive
                ? ((VIDEO_DURATION_SEC - videoSecondsLeft) /
                    VIDEO_DURATION_SEC) *
                  100
                : 0;
              return (
                <div
                  key={vid.id}
                  className={`rounded-2xl overflow-hidden shadow-lg border w-[300px] shrink-0 snap-center bg-black transition-all duration-300 ${
                    isActive
                      ? "border-blue-500 shadow-blue-500/30 scale-[1.02]"
                      : "border-slate-100"
                  }`}
                >
                  <div
      ...
      <motion.section
        ...
        viewport={{ once: true, amount: 0.1 }}
        transition={{ duration: 0.7, ease: "easeOut" }}
        className="py-24 bg-surface-container-low dark:bg-slate-900 border-y border-outline-variant/10"
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-on-surface-variant max-w-2xl mx-auto text-lg leading-relaxed">
              Experience our state-of-the-art facilities designed for immersive
              learning and collaborative project building.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <motion.div
              ...
              className="col-span-2 row-span-2 rounded-3xl overflow-hidden shadow-lg h-full min-h-[300px] md:min-h-[500px]"
            >
              <img
                className="w-full h-full object-cover hover:scale-110 transition-transform duration-700"
                src="/images/campus/campus_main.jpg"
                alt="Main Classroom"
              />
            </motion.div>
            <motion.div
              ...
              className="col-span-2 rounded-3xl overflow-hidden shadow-lg h-auto bg-white flex items-center justify-center p-2"
            >
              <img
                className="w-full h-auto object-contain rounded-xl hover:scale-105 transition-transform duration-700"
                src="/images/campus/new_gallery_photo.jpg"
                alt="Campus facility"
              />
            </motion.div>
            <motion.div
              ...
              whileInView={{ scale: 1, opacity: 1 }}
              transition={{ duration: 0.8 }}
              className="rounded-3xl overflow-hidden shadow-lg h-32 md:h-[242px]"
            >
              <img
                className="w-full h-full object-cover hover:scale-110 transition-transform duration-700"
            ...
            <motion.div
              ...
              className="col-span-2 md:col-span-4 rounded-3xl overflow-hidden shadow-lg h-64 md:h-[500px] bg-slate-50 dark:bg-slate-800 flex items-center justify-center p-2"
            >
              <img
                className="max-w-full max-h-full object-contain rounded-2xl shadow-sm hover:scale-[1.02] transition-transform duration-700"
                src="/images/campus/new_campus_1.jpg"
                alt="New campus facility 1"
              />
            </motion.div>
            ...
            <motion.div
              ...
              className="col-span-1 md:col-span-2 rounded-3xl overflow-hidden shadow-lg h-40 md:h-[300px]"
            >
              <img
                className="w-full h-full object-cover hover:scale-110 transition-transform duration-700"
                src="/images/campus/new_campus_2.jpg"
                alt="New campus facility 2"
              />
            </motion.div>
            <motion.div
              initial={{ scale: 0.95, opacity: 0 }}
            ...
            >
              <img
                className="w-full h-full object-cover hover:scale-110 transition-transform duration-700"
                src="/images/campus/new_campus_3.jpg"
                alt="New campus facility 3"
              />
            </motion.div>
          </div>
        </div>
      ...
      >
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-4">
            <details
              className="group bg-surface-container-lowest rounded-xl border border-outline-variant/10 shadow-sm"
              open=""
            >
              ...
              <div className="px-6 pb-6 text-on-surface-variant leading-relaxed">
                While we don't use the word "guaranteed" for legal reasons, we
                have a 99% placement record and over 50+ hiring partners. We
                provide unlimited interview opportunities until you land a job.
              </div>
            </details>
            <details className="group bg-surface-container-lowest rounded-xl border border-outline-variant/10 shadow-sm">
              ...
              <div className="px-6 pb-6 text-on-surface-variant leading-relaxed">
                Any graduate (B.Com, BBA, B.Sc, B.A, etc.) or post-graduate
                looking to start a career in Finance or HR can apply. Even final
            ...
            <details className="group bg-surface-container-lowest rounded-xl border border-outline-variant/10 shadow-sm">
              ...
              <div className="px-6 pb-6 text-on-surface-variant leading-relaxed">
                The programs run for 2 months, with approximately 4-5 hours of
                intensive practical training daily, including lab sessions.
              </div>
            </details>
            <details className="group bg-surface-container-lowest rounded-xl border border-outline-variant/10 shadow-sm">
              <summary className="list-none p-6 flex justify-between items-center cursor-pointer font-bold text-lg select-none">
              ...
              <div className="px-6 pb-6 text-on-surface-variant leading-relaxed">
                Yes, we offer flexible EMI options and installment plans to make
                the professional education accessible to everyone.
              </div>
            </details>
          </div>
        </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-white/80 text-xl mb-12 max-w-2xl mx-auto">
            Join 6,900+ successful professionals. Book a free career counseling
            session now.
          </p>
